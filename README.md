...
This app is not currently available through any app store, so to run it, you'll have to get the .apk and install the app manually.
 ...
 2. Download the .apk [here](http://www.cs.rit.edu/~css7209/Resources/Android/) (you'll want to download the latest version of the app, though various benchmark tags will also be available.)<br>
